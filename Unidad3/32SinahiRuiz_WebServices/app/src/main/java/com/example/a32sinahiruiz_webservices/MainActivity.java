package com.example.a32sinahiruiz_webservices;
...
public class MainActivity extends AppCompatActivity {
    ImageView imageView;
    TextView nombre, user, repo, seguidores, siguiendo, descripcion;
    Button button;
    EditText editText;
    ProgressDialog pd;
    ...
    private class JsonTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                data += "," + mainObject.getString("bio");
                data += "," + mainObject.getString("followers");
                data += "," + mainObject.getString("following");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                descripcion.setText("Bio Descripcion: " + dat[4]);
                seguidores.setText("Seguidores: " + dat[5]);
                siguiendo.setText("Siguiendo: " + dat[6]);
            } catch (Exception e) {
