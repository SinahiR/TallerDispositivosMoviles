package com.example.a35firebasesinahiruizr;
...
import com.example.a35firebasesinahiruizr.model.Cliente;
            ...
            public void onClick(View v) {
                ...
                q.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (cierto == true){
                            Toast.makeText(Main2Activity.this, "La licencia es igual \n y se sumo los puntos y monto", Toast.LENGTH_LONG).show();
                        }else{
